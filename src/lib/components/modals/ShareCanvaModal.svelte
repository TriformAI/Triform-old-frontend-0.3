...
<!-- Modal Container -->
<div
	class="absolute w-[40rem] right-[32rem] bg-website-secondary text-brand-tertiary-gray border border-brand-primary-gray rounded-lg shadow-lg z-50"
		...
		<div>
			<div class="flex items-center pt-8">
				...
				<select
					...
					class="px-4 py-3 w-[15rem] ml-auto border rounded-md bg-[#1D1E1F] border-brand-primary-gray"
				>
					<option>Admin</option>
			...
			</div><div class="flex items-center pt-8">
				<img alt="profile logo" src={profile_logo} class="w-8 mr-3" />
				<h4 class="text-lg text-white">Iggy</h4>
				<select
					id="Label"
