...
<button
	class="absolute w-[95%] mx-auto bottom-28 right-14 bg-website-secondary text-[#D1D5DB] border border-[#FFFFFF1A] rounded-lg shadow-lg z-50"
	...
	<div class="flex flex-col gap-y-5 py-6 px-4 border-b border-[#FFFFFF1A]">
		<div class="flex items-center justify-between">
			...
			<div class="flex items-center gap-x-10">
				...
				<div class="border-l border-l-[#FFFFFF1A] pl-8">
					{#if pined_unpined}
