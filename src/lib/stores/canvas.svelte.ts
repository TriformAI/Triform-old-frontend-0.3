...
export type AgentSpec = AgentSpecV1 & {
	agent: Statement
}
...
export type Sequence = Omit<SequenceStatementV1, 'sequence'> & { sequence: Statement[] }
export type Parallel = Omit<ParallelStatementV1, 'parallel'> & { parallel: Statement[] }

export type Statement = AgentResource | ActionResource | Sequence | Parallel
...
export const isAgent = (resource: ResourceV1): resource is AgentResource => {
	if (typeof resource !== 'object' || resource === null) return false
	return resource.resource === 'agent'
}
export const isAction = (resource: ResourceV1): resource is ActionResource => {
	if (typeof resource !== 'object' || resource === null) return false
	return resource.resource === 'action'
}
export const isSequence = (val: StatementV1): val is SequenceStatementV1 => {
	if (typeof val !== 'object' || val === null) return false
	return 'sequence' in val
}
export const isParallel = (val: StatementV1): val is ParallelStatementV1 => {
	if (typeof val !== 'object' || val === null) return false
