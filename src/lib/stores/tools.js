...
export const iconsStore = writable([
	{ id: 1, icon: toolbar_icon_1, alt: 'Toolbar Icon 1', visibleOnToolbar: true },
	{ id: 2, icon: toolbar_icon_2, alt: 'Toolbar Icon 2', visibleOnToolbar: true },
	{ id: 3, icon: toolbar_icon_3, alt: 'Toolbar Icon 3', visibleOnToolbar: true },
	{ id: 4, icon: toolbar_icon_4, alt: 'Toolbar Icon 4', visibleOnToolbar: true },
	{ id: 5, icon: toolbar_icon_5, alt: 'Toolbar Icon 5', visibleOnToolbar: true },
	{ id: 6, icon: toolbar_icon_6, alt: 'Toolbar Icon 6', visibleOnToolbar: false },
	{ id: 7, icon: toolbar_icon_7, alt: 'Toolbar Icon 7', visibleOnToolbar: false },
	{ id: 8, icon: more_tools_1, alt: 'More Tools Icon 1', visibleOnToolbar: false },
	{ id: 9, icon: more_tools_2, alt: 'More Tools Icon 2', visibleOnToolbar: false }
]);

// Add or remove icon from toolbar
/**
 * @param {number} id
 */
