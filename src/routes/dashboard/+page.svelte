...
>
	<div class="flex flex-col items-center justify-center max-w-xl mx-auto my-auto text-center">
		...
		{#if createModuleModal}
			<div
				class="absolute w-[60rem] mx-auto bg-website-secondary text-[#D1D5DB] border border-[#FFFFFF1A] rounded-2xl shadow-lg z-50"
			...
			>
				...
				<!-- Modal Body -->
				<div class="bg-[#0B1544] rounded-b-2xl">
					<form
						class="grid grid-cols-2 gap-6 px-6 py-12 text-left divide-x-2 divide-[#FFFFFF1A]"
					>
						<!-- Left Column -->
						<div class="p-4">
							<!-- Name Input -->
