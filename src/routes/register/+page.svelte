...
<section>
	<div class="flex h-screen flex-1 items-center justify-center bg-gray-900">
		<div>
			...
			>
				<form on:submit|preventDefault={handleSignup} id="register-form">
					...
					<div class="my-4 space-y-2">
						...
						<div class="relative">
							...
							>
								{#if !showPassword}
									<!-- Eye icon SVG for "Show Password" -->
									<svg
								...
								{:else}
									<!-- Eye slash icon SVG for "Hide Password" -->
									<svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 640 512"
										class="h-5 w-5 text-white"
					...
					<div class="my-4 space-y-2">
						<label for="password_confirmation" class="block text-sm text-white"
				...
				>
					...
					<p><x-heroicon-o-arrow-right class="h-5 w-5 text-white"></x-heroicon-o-arrow-right></p>
				</button>
				<h3 class="truncate text-center text-xs text-gray-400">
					Already have an account <a
						href="/login"
						class="cursor-pointer font-bold text-gray-200 hover:underline">Login</a
					>
				</h3>
			</div>
		</div>
